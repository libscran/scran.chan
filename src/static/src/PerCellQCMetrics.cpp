...
void scran::sttc::PerCellQCMetrics(const scran::sttc::Matrix& mat, std::vector<const double*> subsets, double* sums, int* detected, std::vector<double*> subset_proportions) {
