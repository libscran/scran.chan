...
score_markers_full <- function(x, groups, batch, simple_means_only, lfc, nthreads) {
    .Call('_scran_chan_score_markers_full', PACKAGE = 'scran.chan', x, groups, batch, simple_means_only, lfc, nthreads)
}
